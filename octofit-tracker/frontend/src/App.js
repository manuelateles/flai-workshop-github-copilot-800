        ...
        <div className="col-md-4 mb-4">
          <div className="card text-center">
            <div className="card-body">
              ...
              <p className="card-text">Create or join teams and compete together for glory!</p>
        ...
        <div className="col-md-4 mb-4">
          <div className="card text-center">
            <div className="card-body">
              ...
              <p className="card-text">See who's leading the competition and aim for the top!</p>
        ...
        <div className="col-md-6 mb-4">
          <div className="card text-center">
            <div className="card-body">
              ...
              <p className="card-text">Get personalized workout recommendations tailored for you.</p>
